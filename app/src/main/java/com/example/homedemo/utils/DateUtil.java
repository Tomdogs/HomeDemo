...
public class DateUtil {
    ...
    public static String getSessionTime(long mTimeStamp) {
        ...
        SimpleDateFormat formatToday = new SimpleDateFormat("HH:mm");//24小时
//        SimpleDateFormat formatToday = new SimpleDateFormat("hh:mm");//12小时
        /**消息时间戳*/
     ...
     * @return
     */
    public static long getTodayLastDate() {
    ...
    public static String getTimeDiffDesc(Long date) {
...
//        thenCalendar.setTime(date);
        thenCalendar.setTimeInMillis(date);
        ...
        if (thenCalendar.after(today))// today
        {
        ...
        } else if (thenCalendar.before(yesterday) && thenCalendar.after(sevendaysago)) {// 2 ~ 7days ago
            ...
            if (h < 6) {
                strDesc = (thenMonth + 1) + "月" + thenDay + "日";
            } else if (h < 12) {
                strDesc = (thenMonth + 1) + "月" + thenDay + "日";
            } else if (h < 13) {
                strDesc = (thenMonth + 1) + "月" + thenDay + "日";
    ...
    * */
    ...
    public static String parseTime(String time) {
        ...
        SimpleDateFormat dateFormatTarget = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        SimpleDateFormat dateFormatInput = new SimpleDateFormat("yyyyMMddHHmmss");
        if (TextUtils.isEmpty(time)) return "";
        try {
            return dateFormatTarget.format(dateFormatInput.parse(time));
    ...
    public static String parseIncompleteTime(String time) {

        SimpleDateFormat dateFormatTarget = new SimpleDateFormat("MM-dd HH:mm:ss");
        SimpleDateFormat dateFormatInput = new SimpleDateFormat("yyyyMMddHHmmss");
     ...
     * @return
     */
    public static String stampToStringTime(long stamp) {
